...
\title{Front Loader \LaTeX{} Package \\
...
\begin{abstract}
The \texttt{frontloader} package provides a convenient way to X. 
% It defines a starred proof environment \verb|proof*| that behaves like the standard \verb|proof| environment from \texttt{amsthm}, but optionally hides its body and replaces it with a customizable message.
...
% Issues and feature requests can be submitted on GitHub at \href{https://github.com/pwintz/frontloader}{github.com/pwintz/frontloader}.
\end{abstract}
...
This package requires \LaTeX3 support.

% \section{Installation}
% 
% Eventually, \texttt{frontloader} may be bundled with \LaTeX{} installations. 
% Until then, you must install it manually. 
% The 
% % TODO: Update this.
% Put \texttt{frontloader.sty} in your project's directory or somewhere in your \TeX\ path. 

%===================================
%===================================
\section{Usage}
\label{sec:Usage}
To use the \texttt{frontloader} package, load it in your document preamble:
...
% \end{lstlisting}
% % \makeatletter
%   % \frontloader@setDefaults{}%
%   % \frontloader@newSetup{
%   %   hideInFinal=true,
